package Builder.BuilderExample.director;

import Builder.BuilderExample.builders.Builder;
...
public class Director {
    ...
    public void constructVocho(Builder builder){
        builder.setCarType(CarType.VOCHO);
        builder.setSeats(4);
        builder.setEngine(new Engine(3.0,0));
        builder.setTransmission(Transmission.MANUAL);
    }
